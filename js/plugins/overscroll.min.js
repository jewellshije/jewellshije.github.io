                ...
                z = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.onRender = function(t) {
                            if (this._enabled) {
                                ...
                                !this._amplitude.x &&
                                    ...
                                    ((e = 0), this._absorbMomentum('x', t.x)), !this._amplitude.y &&
                        ...
                        (e.prototype.transformDelta = function(t, e) {
                            if (
                                ((this._lastEventType = e.type), !this._enabled || !B.test(e.type))
                            )
                                return t;
                            this._isWheelLocked &&
                                /wheel/.test(e.type) &&
                        ...
                        (e.prototype._nextAmp = function(t) {
                            ...
                            return (!this._touching &&
                                ...
                                this._wheelScrollBack[t] &&
                                Math.abs(a) <= 1 &&
                                ((this._wheelScrollBack[t] = !1), (this._lockWheel[t] = !0)), { amplitude: c, position: a }
                            );
                        }),
